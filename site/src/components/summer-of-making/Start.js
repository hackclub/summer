    ...
    <Grid mt={[4, 5]} mb={[3, 4]} px={3}>
      ...
      <div>
        <Timeline>
          ...
          <Timeline.Step name="Application Results" duration="On June 10th" />
          <Timeline.Step name="Meet your Mentor" duration="July 4/5th" />
          <Timeline.Step name="Get Making!" duration="July 6th" />
        </Timeline>
