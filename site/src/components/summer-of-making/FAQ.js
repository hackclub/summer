  ...
  <Base pt={[5, 6, 7]} pb={[4, 5, 6]} color="snow">
    <Modules px={3}>
      ...
      <Module
        ...
        body="This program is a Hack Club Community Initiative, being ran by <strong> @sampoder </strong>, @roshan & @neelr. The event has been sanctioned by Hack Club HQ. Hack Club is a non profit network of computer science clubs where members learn to code through tinkering and building projects. It is the biggest such network and has gained the attention of tech luminaries like Elon Musk!"
      />
